...
public abstract class MalaLocationSkill extends SkillHandler<LocationSkillResult> implements Not_Skill
{
	public double range = 50.0;
	
	public MalaLocationSkill(String id, String str, Material material, String... str2)
	{
