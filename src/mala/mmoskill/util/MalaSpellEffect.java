...
public abstract class MalaSpellEffect implements Runnable
{
	...
	public MalaSpellEffect(Player player, double duration, String cooldownName, double cooldown)
	{
		this(player, duration);
	}
	public MalaSpellEffect(LivingEntity attacker, double duration)
	{
		...
		SpellCastEvent castEvent = new SpellCastEvent(attacker, this);
	...
	{
		if (cancelled) {
			attacker.sendMessage("§c시전중이던 스펠이 취소됐습니다.");
			return;
		}
